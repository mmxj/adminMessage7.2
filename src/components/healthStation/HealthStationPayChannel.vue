  ...
  <div id="MerchantChannelOne">
    ...
    <div class="merchantMessage">
      <div class="messageBox">
        <span class="messageBox-title"><i class="icon el-icon-info"></i>卫生站信息</span>
        <br>
        <span>卫生站编号：</span>
    ...
    <div class="forms">
      ...
      <div class="form-box">
        ...
        <div class="button-box" v-if="status==1">
          ...
          <el-button size="small" @click="$router.push('/healthstation')" class="other-button">关闭</el-button>
        </div>
  ...
  export default{
    ...
    methods:{
      ...
      next(){ //下一步
        if(this.radio!=null){
          var off=false;
          this.hasChannel.forEach(function(item){
              if(item=='银联小微商户'){
                  off=true
              }
          })
          if(off){
              this.$alert('该终端号已经配置过小微商户，请在管理渠道中进行修改');
              return
          }
