  ...
  <div id="MerchantMessage">
    <div class="form-wrap">
      <el-form inline :model="formData">
        ...
        <el-form-item label="商户地区"  labelWidth="120px">
          <div class="address">
    ...
    <div class="table-wrap">
      <!--<div class="tool-button">-->
        ...
        <!--<el-button size="small" class="addMerchant">商户申请列表</el-button>-->
      <!--</div>-->
      <div class="table-box">
        <el-table
          :data="tableData"
        ...
        >
          ...
          <el-table-column align="center" label="商户类型"  min-width="70">
            <template slot-scope="props">
              {{companyTypeShow(props.row.companyType)}}
            </template>
          </el-table-column>
          <el-table-column align="center" label="商户名称" prop="name" min-width="90"></el-table-column>
          ...
          <el-table-column align="center" label="支付渠道配置" min-width="110">
            <template slot-scope="props">
              <span class="button" :class="props.row.auditFlag=='审核通过'?null:'nobutton'" @click="props.row.auditFlag=='审核通过'?$router.push({name:'MerchantChannelOne',params:{data:props.row}}):null">配置渠道</span>
              <span class="button" :class="props.row.auditFlag=='审核通过'?null:'nobutton'" @click="props.row.auditFlag=='审核通过'?$router.push({name:'MerchantChannelList',params:{data:props.row}}):null">管理渠道</span>
            </template>
          </el-table-column>
        </el-table>
      </div>
    ...
    <div class="pagination clearfix">
        <el-pagination
         ...
         <div class="statistics">总共 {{total}} 个商户</div>
    </div>
