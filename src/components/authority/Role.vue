<template>
  <div id="Department">
    <!--新增按钮-->
    <div class="addNews">
      <el-button size="small" type="primary" @click="$router.push('/roleadd')"><i class="el-icon-plus"></i>新增角色</el-button>
    </div>
    <!--表格-->
    <div class="table-warp">
      ...
      >
        ...
        <el-table-column align="center" label="角色名称" prop="name" min-width="100"></el-table-column>
        <el-table-column align="center" label="角色编号" prop="code" min-width="100"></el-table-column>
        <el-table-column align="center" label="所属部门" prop="departmentName" min-width="100"></el-table-column>
        <el-table-column align="center" label="角色权限" min-width="60" >
        ...
        <el-table-column align="center" label="操作" prop="" min-width="100">
          <template slot-scope="scope">
            <span class="button" @click="$router.push({name:'RoleUpdate',params:{data:scope.row}})">编辑</span>
...
//            provinceId:unit.removeEmptyString(vm.staffProvinceId),
      ...
      deleteFaq(id){
        var vm=this;
        if(vm.roleId==id){
          vm.$confirm('不能删除自己所属的角色', '提示')
        }else{
          vm.$confirm('确定删除该角色', '提示', {
