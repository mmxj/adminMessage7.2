<template>
  <div id="SystemMaintenance">
    <el-row :gutter="20">
      ...
      <el-col :span="6"><el-input type="text" size="small" placeholder="请输入密钥" v-model="openApi"></el-input></el-col>
      <el-col :span="3">
        <el-button size="small" @click="upDataOpenapi">点击刷新</el-button>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="4">
      ...
      <el-col :span="3">
        <el-button size="small" @click="dealUpdata">点击刷新</el-button>
      </el-col>
    </el-row>
  </div>
</template>
