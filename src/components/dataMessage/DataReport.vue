<template>
  <div id="DataReport">
    <div>
      ...
      <el-table v-show="show[0]" :data="tableData" border max-height="600">
      ...
      <el-table v-show="show[1]" :data="tableData" border max-height="600">
        <el-table-column prop="companyName" label="商户名称"></el-table-column>
        <el-table-column prop="personPayType" label="支付类型"></el-table-column>
        <el-table-column prop="payTotalMoney" label="支付总金额"></el-table-column>
        <el-table-column prop="payTotalCount" label="交易笔数"></el-table-column>
      </el-table>
      <el-table v-show="show[2]" :data="tableData" border max-height="600">
      ...
      <el-table v-show="show[3]" :data="tableData" border max-height="600">
      ...
      <el-table v-show="show[4]" :data="tableData" border max-height="600">
              ...
              for (var i = 0; i < vm.tableData.length; i++) {
                ...
                switch (vm.tableData[i].personPayType) {
                  ...
                  case 5:
                    ...
                    break;
                  case 6:
                    vm.tableData[i].personPayType = '社保个账'
                    break;
                  case 7:
                    vm.tableData[i].personPayType = '支付宝'
                    break;
                  case 8:
                    vm.tableData[i].personPayType = '微信'
                    break;
                  case 9:
                    vm.tableData[i].personPayType = '社保个账在线支付'
                    break;
                  case 10:
                    vm.tableData[i].personPayType = '银行卡在线支付'
                    break;
                  case 11:
                    vm.tableData[i].personPayType = '已现金支付'
                    break;
                  case 12:
                    vm.tableData[i].personPayType = '已刷社保卡支付'
                    break;
                  case 13:
                    vm.tableData[i].personPayType = '已微信支付'
                    break;
                  case 14:
                    vm.tableData[i].personPayType = '已支付宝支付'
                    break;
                  case 15:
                    vm.tableData[i].personPayType = '已刷银联卡支付'
                    break;
                }

                switch (vm.tableData[i].personalPayType) {
                  case 1:
                    vm.tableData[i].personalPayType = '社保个账银联扫码主扫支付'
                    break;
                  case 2:
                    vm.tableData[i].personalPayType = '银行卡银联扫码主扫支付'
                    break;
                  case 3:
                    vm.tableData[i].personalPayType = '社保个账银联扫码被扫支付'
                    break;
                  case 4:
                    vm.tableData[i].personalPayType = '银行卡银联扫码被扫支付'
                    break;
                  case 5:
                    vm.tableData[i].personalPayType = '银行卡pos刷卡'
                    break;
                  case 6:
                    vm.tableData[i].personalPayType = '社保个账'
                    break;
                  case 7:
                    vm.tableData[i].personalPayType = '支付宝'
                    break;
                  case 8:
                    vm.tableData[i].personalPayType = '微信'
                    break;
                  case 9:
                    vm.tableData[i].personalPayType = '社保个账在线支付'
                    break;
                  case 10:
                    vm.tableData[i].personalPayType = '银行卡在线支付'
                    break;
                  case 11:
                    vm.tableData[i].personalPayType = '已现金支付'
                    break;
                  case 12:
                    vm.tableData[i].personalPayType = '已刷社保卡支付'
                    break;
                  case 13:
                    vm.tableData[i].personalPayType = '已微信支付'
                    break;
                  case 14:
                    vm.tableData[i].personalPayType = '已支付宝支付'
                    break;
                  case 15:
                    vm.tableData[i].personalPayType = '已刷银联卡支付'
                    break;
                  default :
                    vm.tableData[i].personalPayType = null;
                    break;
                }
