  ...
  <div id="MerchantChannelList">
    ...
    <div class="table-wrap">
      ...
      >
        ...
        <el-table-column align="center" label="商户号" prop="merchantNo" min-width="180"></el-table-column>
        ...
        <el-table-column align="center" label="操作" min-width="180">
          <template slot-scope="prop">
            <span class="tool" :class="prop.row.payChannelTypeId=='2'||prop.row.payChannelTypeId=='3'?null:'noclick'" @click="prop.row.payChannelTypeId=='2'||prop.row.payChannelTypeId=='3'?$router.push({name:'MerchantChannelUpdate',params:{data:prop.row,start:startData}}):null">编辑</span>
          </template>
        </el-table-column>
      </el-table>
    </div>
