    ...
    <div class="table-wrap">
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column align="center" label="商户编号" prop="no" min-width="80"></el-table-column>
          <el-table-column align="center" label="商户类型"  min-width="80">
            <template slot-scope="props">
              {{companyTypeShow(props.row.companyType)}}
            </template>
          </el-table-column>
          <el-table-column align="center" label="商户名称" prop="name" min-width="100"></el-table-column>
          <el-table-column align="center" label="商户地址" prop="address" show-overflow-tooltip min-width="100" ></el-table-column>
          <el-table-column align="left" label="审核状态" prop="auditFlag" width="110"
          ...
          <el-table-column align="center" label="操作" width="150">
            <template slot-scope="props">
              <span class="button" :class="props.row.auditFlag=='审核通过'?'disable':null" @click="props.row.auditFlag=='审核通过'?null:$router.push({name:'MerchantUpdate',params:{data:props.row}})">编辑</span>
              <span class="button" :class="props.row.auditFlag=='审核通过'?'disable':null" @click="props.row.auditFlag=='审核通过'?null:deleteMerchant(props.row.id)">删除</span>
              <!--<span class="el-dropdown-link" :class="'disable'" v-if="props.row.auditFlag=='审核通过'||props.row.auditFlag=='审核不通过'">-->
                  <!--审核<i class="el-icon-arrow-down el-icon&#45;&#45;right"></i>-->
                <!--</span>-->
              <!--<el-dropdown @command="handleCommand" v-if="!(props.row.auditFlag=='审核通过'||props.row.auditFlag=='审核不通过')">-->
                <!--<span class="el-dropdown-link">-->
                  <!--审核<i class="el-icon-arrow-down el-icon&#45;&#45;right"></i>-->
                <!--</span>-->
              <!--<el-dropdown-menu slot="dropdown">-->
                <!--<el-dropdown-item :command="{id:props.row.id,type:1}">审核通过</el-dropdown-item>-->
                <!--<el-dropdown-item :command="{id:props.row.id,type:2}">审核不通过</el-dropdown-item>-->
              <!--</el-dropdown-menu>-->
              <!--</el-dropdown>-->
            </template>
          </el-table-column>
